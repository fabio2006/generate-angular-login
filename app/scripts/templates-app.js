angular.module('templates-app', ['templates/admin.tpl.html', 'templates/error.tpl.html', 'templates/home.tpl.html', 'templates/register.tpl.html', 'templates/user.tpl.html']);

angular.module('templates/admin.tpl.html', []).run(['$templateCache', function($templateCache) {
  'use strict';
  $templateCache.put('templates/admin.tpl.html',
    '<div class="jumbotron">\n' +
...
angular.module('templates/home.tpl.html', []).run(['$templateCache', function($templateCache) {
  'use strict';
...
angular.module('templates/register.tpl.html', []).run(['$templateCache', function($templateCache) {
  'use strict';
  $templateCache.put('templates/register.tpl.html',
...
angular.module('templates/user.tpl.html', []).run(['$templateCache', function($templateCache) {
  'use strict';
  $templateCache.put('templates/user.tpl.html',
    '<div class="jumbotron">\n' +
