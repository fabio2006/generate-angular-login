...
angular.module('templates/admin.tpl.html', []).run(['$templateCache',
...
angular.module('templates/error.tpl.html', []).run(['$templateCache',
  function($templateCache) {
    'use strict';
...
angular.module('templates/home.tpl.html', []).run(['$templateCache',
  function($templateCache) {
    'use strict';
...
angular.module('templates/register.tpl.html', []).run(['$templateCache',
  function($templateCache) {
    'use strict';
...
angular.module('templates/user.tpl.html', []).run(['$templateCache',
  function($templateCache) {
    'use strict';
